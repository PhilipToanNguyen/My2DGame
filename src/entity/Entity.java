...
public class Entity {
    ...
    public Entity(GamePanel gp) { //Abstrakt klasse. denne klassen har ikke instanse Ep 14
        this.gp = gp;
    }
    ...
    public BufferedImage setup(String imagePath) {
        ...
        try {
            image = ImageIO.read(getClass().getResourceAsStream(imagePath + ".png")); //Optimalisert episode 11 16:00
